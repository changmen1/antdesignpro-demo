...
const PicSearcher: React.FC = () => {
  ...
  return (
    <div className="iconPicSearcher">
      <Popover
        content={'app.docs.components.icon.pic-searcher.intro'}
      ...
      >
        {state.modelLoaded || (
          <Spin
            ...
            tip={'app.docs.components.icon.pic-searcher.modelloading'}
          >
        ...
        <Spin
          ...
          tip={'app.docs.components.icon.pic-searcher.matching'}
        >
          <div className="icon-pic-search-result">
              ...
              {state.icons.length > 0 && (
                <thead>
                  <tr>
                    ...
                    <th>{'app.docs.components.icon.pic-searcher.th-score'}</th>
                  </tr>
                </thead>
              )}
              <tbody>
            ...
            {state.error && (
              <Result
                status="500"
                title="503"
                subTitle={'app.docs.components.icon.pic-searcher.server-error'}
              />
            )}
          </div>
        </Spin>
